        ...
        <div className="container mx-auto flex h-20 max-w-7xl items-center justify-between px-6">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-4">
              {account ? (
                <Button
                  className="font-mono text-xs font-black uppercase tracking-widest bg-foreground text-background border-2 border-foreground shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-none hover:translate-x-[2px] hover:translate-y-[2px] transition-all"
                  asChild
                >
