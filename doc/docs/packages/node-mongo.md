...
#### `service.find(query, options)`

```typescript
const { results: users, count: usersCount } = await usersService.find(
  { status: 'active' },
);
```
...
**Parameters**
- query: [`Filter<T>`](https://mongodb.github.io/node-mongodb-native/4.7/modules.html#Filter);
- options: [`FindOptions`](https://mongodb.github.io/node-mongodb-native/4.7/interfaces/FindOptions.html) & [`QueryDefaultsOptions`](#querydefaultsoptions) & { perPage = 100, page = 0 };
