...
* Ship is based on 20+ tiny components. We manually combine them together and test upon new release.
* Every component is kept is tiny as possible to simplify maintenance and stay up to date with new releases.
* Ship is always in production ready state.

## Ship components

TODO: list all components used to build current Ship version. Make a release after this.
