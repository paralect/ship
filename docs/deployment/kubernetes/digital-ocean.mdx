...
First, initialize your project. Type `npx create-ship-app init` in the terminal then choose **Digital Ocean Managed Kubernetes** deployment type.
...
- [**API**](/api-reference/overview) - registry.digitalocean.com/oigen43/my-app-api;
- [**Scheduler**](/scheduler) - registry.digitalocean.com/oigen43/my-app-scheduler;
- [**Migrator**](/migrator) - registry.digitalocean.com/oigen43/my-app-migrator;
- [**Web**](/web/overview) - registry.digitalocean.com/oigen43/my-app-web;
...
![Cluster Region](/images/cluster-region.png)
...
![Cluster Price](/images/cluster-price.png)
...
![Kubeconfig Download](/images/kubeconfig-download.png)

```yaml my-app-kubeconfig.yaml
clusters:
  - cluster:
...
![Pods List](/images/pods-list.png)
...
![Digital Ocean Update Token](/images/do-token-update.png)
...
<Warning>
  Be careful with Personal Access Token, if someone steals it he will get access
...
| [regcred](https://github.com/paralect/ship/blob/main/deploy/digital-ocean/deploy/dependencies/regcred/bin/create-docker-regcred.sh) | Bash script for creating Kubernetes [Secret](https://kubernetes.io/docs/concepts/configuration/secret/). Secret needs for authorizing in Container Registry when pulling images from cluster |

<Tip>
  You can read
  **[here](https://docs.nginx.com/nginx-ingress-controller/intro/how-nginx-ingress-controller-works/)**
