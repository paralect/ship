...
<Steps>
  ...
  <Step title="Switch context to your new cluster">
  ...
  <Step title="Get information about installed pods in the cluster">
    Try to get information about installed pods in the cluster with:
...
If you did all steps correctly you will see info about installed pods in the cluster.
