...
To deploy api, you need to set up environment variables.

Open `deploy/bin` folder and run the bash script. Follow instructions in terminal.
You will need to set up **secret name**, **stage** (staging, production) and necessary environment variables (**MONGO_URI**, **MONGO_DB_NAME**, **API_URL**, **WEB_URL**).
Also, you can add your custom variables in the end.
