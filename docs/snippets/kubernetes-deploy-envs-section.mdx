...
* **DATABASE_URL** (requires encoding)
* **API_URL**
* **WEB_URL**
...
VITE_API_URL=https://my-app-api.paralect.com
VITE_WS_URL=https://my-app-api.paralect.com
VITE_WEB_URL=https://my-app.paralect.com
```
