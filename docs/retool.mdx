...
2. Import prebuilt applications from retool [folder](https://github.com/paralect/ship/tree/main/template/apps/api/src/config/retool) in Ship. Open `Apps` > ` Create New` > `From JSON` and choose needed.
